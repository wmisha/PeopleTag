...
public class DeletePersonCollectionServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    try {
      personcollectionDao.deletePersonCollection(id);
      resp.sendRedirect("/personcollections");
    } catch (Exception e) {
      throw new ServletException("Error deleting collection", e);
    }
  }
}
// [END example]
