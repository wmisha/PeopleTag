...
public class CreateCollectionServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    req.setAttribute("page", "collectionForm");           // Tells base.jsp to include collectionForm.jsp
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException,
    ...
    try {
      Long id = collectionDao.createCollection(collection);
      resp.sendRedirect("/readCollection?id=" + id.toString());   // read what we just wrote
    } catch (Exception e) {
      throw new ServletException("Error creating collection", e);
    }
  }
  // [END formpost]
}
